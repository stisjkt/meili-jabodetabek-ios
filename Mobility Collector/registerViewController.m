...
//                                    initWithTitle:@"Close" style:UIBarButtonItemStyleDone
//                                    target:self action:@selector(closeMe:)];
...
-(void) sendRegisterURLRequest: (NSString*)username password:(NSString*)password{
    ...
    NSMutableURLRequest *request = [[NSMutableURLRequest alloc] initWithURL:[NSURL URLWithString:@"http://pkks-dev.stis.ac.id/users/registerUser"]];
